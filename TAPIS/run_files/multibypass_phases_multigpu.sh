# Experiment setup
NUM_GPUS=2 # this machine has 2x A100 80GB free; adjust to taste
BATCH_SIZE_PER_GPU=24 # matches multibypass_phases.sh's single-GPU batch size
...
TRAIN.BATCH_SIZE $TOTAL_BATCH_SIZE \
TEST.BATCH_SIZE $TOTAL_BATCH_SIZE \
