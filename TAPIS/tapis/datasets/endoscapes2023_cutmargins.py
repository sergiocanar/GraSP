...
class Endoscapes2023_cutmargins(SurgicalDataset):
    """
    EndoVis 2018 dataloader.
    """

    def __init__(self, cfg, split, load=True):
        self.dataset_name = "Endoscapes2023_cutmargins"
        self.zero_fill = 6
        self.image_type = "jpg"
        self.fps = 1
